...
try:
    from aim2_project.aim2_ontology.parsers import (
        ErrorSeverity, RecoveryStrategy, ErrorContext, ErrorRecoveryStats,
        AbstractParser, OWLParser, CSVParser, JSONLDParser
    )
except ImportError:
...
class TestErrorSeverityClassification:
    ...
    def test_value_error_classification(self, mock_parser):
        ...
        assert result == ErrorSeverity.RECOVERABLE
        mock_parser._classify_error_severity.assert_called_once_with(error, "field validation")
    ...
    def test_key_error_classification(self, mock_parser):
        ...
        mock_parser._classify_error_severity.assert_called_once_with(error, "optional field")
    ...
    def test_memory_error_classification(self, mock_parser):
        ...
        mock_parser._classify_error_severity.assert_called_once_with(error, "large file processing")
    ...
    def test_timeout_error_classification(self, mock_parser):
        ...
        assert result == ErrorSeverity.RECOVERABLE
        mock_parser._classify_error_severity.assert_called_once_with(error, "remote resource")
    ...
    def test_unknown_error_classification(self, mock_parser):
        ...
        assert result == ErrorSeverity.RECOVERABLE
        mock_parser._classify_error_severity.assert_called_once_with(error, "unknown context")
...
class TestRecoveryStrategySelection:
    ...
    def test_strategy_selection_retry_limit(self, mock_parser):
        ...
        error_context = ErrorContext(
            ...
            attempted_recoveries=[RecoveryStrategy.RETRY, RecoveryStrategy.RETRY, RecoveryStrategy.RETRY]
        )
        mock_parser._select_recovery_strategy.return_value = RecoveryStrategy.ABORT
...
class TestAbstractParserErrorRecovery:
    ...
    def test_retry_recovery_strategy(self, mock_abstract_parser):
        ...
        mock_abstract_parser._recover_retry.assert_called_once_with(error_context, max_retries=3)
    ...
    def test_replace_recovery_strategy(self, mock_abstract_parser):
        ...
        result = mock_abstract_parser._recover_replace(error_context, replacement=replacement_data)
        
        assert result == replacement_data
        mock_abstract_parser._recover_replace.assert_called_once_with(error_context, replacement=replacement_data)
    ...
    def test_error_statistics_update(self, mock_abstract_parser):
        ...
        mock_abstract_parser.update_error_stats.assert_called_once_with(error_context, recovery_successful=True)
    ...
    def test_comprehensive_error_handling(self, mock_abstract_parser):
        ...
        result = mock_abstract_parser._handle_parse_error(error, location="test location")
        
        assert result == expected_context
        mock_abstract_parser._handle_parse_error.assert_called_once_with(error, location="test location")
...
class TestOWLParserErrorRecovery:
    ...
    def test_owl_malformed_xml_recovery(self, mock_owl_parser):
        ...
        mock_owl_parser._recover_retry.return_value = {"success": True, "content": sanitized_content}
        
        result = mock_owl_parser._recover_retry(error_context, content="malformed_xml")
        
        assert result["success"] is True
        assert "content" in result
        mock_owl_parser._recover_retry.assert_called_once_with(error_context, content="malformed_xml")
...
class TestJSONLDParserErrorRecovery:
    ...
    def test_jsonld_malformed_json_recovery(self, mock_jsonld_parser):
        ...
        error_context = ErrorContext(
            error=json.JSONDecodeError("Expecting ',' delimiter", '{"invalid": json}', 15),
            severity=ErrorSeverity.RECOVERABLE,
        ...
        mock_jsonld_parser._recover_retry.return_value = {"success": True, "content": sanitized_json}
    ...
    def test_jsonld_content_sanitization(self, mock_jsonld_parser):
        ...
        assert result == sanitized_content
        mock_jsonld_parser._sanitize_json_content.assert_called_once_with(malformed_content)
...
class TestErrorStatisticsTracking:
    ...
    def test_error_stats_tracking(self):
        ...
        stats.recovery_strategies_used["SKIP"] = stats.recovery_strategies_used.get("SKIP", 0) + 1
...
class TestRecoveryFallbackBehaviors:
    ...
    def test_unknown_error_type_fallback(self, mock_parser_with_fallbacks):
        ...
        mock_parser_with_fallbacks._handle_unknown_error.return_value = expected_fallback
        ...
        mock_parser_with_fallbacks._handle_unknown_error.assert_called_once_with(unknown_error)
    ...
    def test_recovery_strategy_failure_fallback(self, mock_parser_with_fallbacks):
        ...
        error_context = ErrorContext(
            ...
            attempted_recoveries=[RecoveryStrategy.SKIP, RecoveryStrategy.DEFAULT, RecoveryStrategy.RETRY]
        )
        last_resort_result = {"fallback": "minimal_data"}
        mock_parser_with_fallbacks._handle_recovery_failure.return_value = last_resort_result
        
        result = mock_parser_with_fallbacks._handle_recovery_failure(error_context)
        
        assert result["fallback"] == "minimal_data"
        mock_parser_with_fallbacks._handle_recovery_failure.assert_called_once_with(error_context)
    ...
    def test_multiple_recovery_attempts_exhausted(self, mock_parser_with_fallbacks):
        ...
        error_context = ErrorContext(
            ...
            attempted_recoveries=[
                RecoveryStrategy.RETRY, RecoveryStrategy.RETRY, RecoveryStrategy.RETRY,
                RecoveryStrategy.SKIP, RecoveryStrategy.DEFAULT
            ]
        )
        last_resort_result = None  # Indicate complete failure
        mock_parser_with_fallbacks._apply_last_resort_recovery.return_value = last_resort_result
        
        result = mock_parser_with_fallbacks._apply_last_resort_recovery(error_context)
        
        assert result is None
        mock_parser_with_fallbacks._apply_last_resort_recovery.assert_called_once_with(error_context)
    ...
    def test_circular_recovery_prevention(self, mock_parser_with_fallbacks):
        ...
        mock_parser_with_fallbacks._handle_recovery_failure.return_value = expected_result
