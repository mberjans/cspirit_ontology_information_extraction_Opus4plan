...
setup(
    ...
    keywords=[
        "ontology", "information-extraction", "nlp", "llm", "ai", 
        "knowledge-graph", "scientific-literature", "entity-recognition",
        "relationship-extraction", "machine-learning", "transformers",
        "bioinformatics", "text-mining", "automation", "synthetic-data"
    ],
