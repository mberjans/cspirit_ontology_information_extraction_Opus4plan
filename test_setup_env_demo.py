...
def main():
    ...
    result = run_command([
        sys.executable, str(test_runner), "--check-deps"
    ...
    try:
        ...
        progress = setup_env.ProgressIndicator("Test")
    ...
    if failed_tests == 0:
        ...
        print("  2. Generate HTML report: python run_setup_env_tests.py --full --html-report")
